        ...
        return (
            <div className="wishlist-page">
                ...
                <div className="empty-state">
                    ...
                    <p>Tap the heart on a product to save it — you can move items to your cart anytime.</p>
        ...
        <div className="wishlist-page">
            <div className="page-header page-header--split">
                ...
                <Link to="/cart" className="page-header-link">
                    View cart
                    <span className="material-symbols-outlined page-header-link-icon page-header-link-icon--trailing">shopping_cart</span>
                </Link>
            </div>
