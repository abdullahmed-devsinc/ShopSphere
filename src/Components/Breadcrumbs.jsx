    ...
    return (
        <nav className="breadcrumbs" aria-label="Breadcrumb">
            ...
            {paths.map((path, index) => {
                ...
                let displayName = decodeURIComponent(path).charAt(0).toUpperCase() + decodeURIComponent(path).slice(1);
                ...
                return (
                    <span key={to} className="breadcrumb-item">
                        ...
                        {isLast ? (
                            ...
                            <Link to={displayName === 'Products' ? '/products' : to} className="breadcrumb-link">
                                {displayName}
                            </Link>
                        )}
                    </span>
